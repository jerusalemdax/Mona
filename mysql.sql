CREATE DATABASE  IF NOT EXISTS `yuzhu520` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `yuzhu520`;
...
INSERT INTO `tb_option` (`id`, `name`, `value`) VALUES (1,'sitename','鱼猪网'),(2,'siteurl','http://yuzhu520.com'),(3,'subtitle','带你装逼带你飞'),(4,'pagesize','2'),(5,'keywords','摄影'),(6,'description','来一场说走就走的旅行'),(8,'theme','double'),(9,'timezone','8'),(10,'stat','<script language=\"javascript\" type=\"text/javascript\" src=\"http://js.users.51.la/17253002.js\"></script>\r\n<noscript><a href=\"http://www.51.la/?17253002\" target=\"_blank\"><img alt=\"&#x6211;&#x8981;&#x5566;&#x514D;&#x8D39;&#x7EDF;&#x8BA1;\" src=\"http://img.users.51.la/17253002.asp\" style=\"border:none\" /></a></noscript>'),(11,'weibo','http://weibo.com/u/1686750222'),(12,'github','https://github.com/jerusalemdax'),(16,'duoshuo','doubleliu'),(17,'albumsize','9');
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tb_user` VALUES (1,'admin','7fef6171469e80d32c0559f88b377245','472790741@qq.com',0,'127.0.0.1','2015-10-12 00:00:00','',1);
/*!40101 SET character_set_client = @saved_cs_client */;
